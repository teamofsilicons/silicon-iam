...
For the application webhook secret it should be possible to rotate the webhook secret and when the request for rotation is initiated it should return that the rotation has successfully took place, and return the new webhook secret.
