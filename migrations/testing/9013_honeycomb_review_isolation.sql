-- Scope management tables introduced after historical testing overlays.
...
BEGIN
 ...
 AND relation.relname=ANY(ARRAY['honeycomb_publication_plans','honeycomb_publication_decisions'])
