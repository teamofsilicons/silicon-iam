-- Unscoped introspection uses the same explicit membership disclosure scope
-- as selected-organization introspection. Preserve the exact live consent,
-- selected-membership, token, application and epoch checks. Legacy roles.read
-- does not authorize disclosure of organization authority.
